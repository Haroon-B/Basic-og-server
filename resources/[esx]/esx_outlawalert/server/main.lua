...
RegisterServerEvent('esx_outlawalert:esx_vangelico_robbery')
AddEventHandler('esx_outlawalert:esx_vangelico_robbery', function(targetCoords, streetName, playerGender)
	if playerGender == 0 then
		playerGender = _U('male')
	else
		playerGender = _U('female')
