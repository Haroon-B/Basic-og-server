...
RegisterNetEvent('esx_outlawalert:esx_vangelico_robbery')
AddEventHandler('esx_outlawalert:esx_vangelico_robbery', function(targetCoords)
	if isPlayerWhitelisted and Config.GunshotAlert then
		local alpha = 250
...
AddEventHandler('police:esx_vangelico_robbery', function()
 local pos = GetEntityCoords(PlayerPedId(), true)
 TriggerServerEvent('esx_outlawalert:JewelRobberyinProgress', {x = pos.x, y = pos.y, z = pos.z}, streetName, playerGender)
end)
