...
AddEventHandler('changetheplayer:modelLoaded', function()
...
function GetNaked()
	TriggerEvent('changetheplayer:getSkin', function()
		if GetEntityModel(PlayerPedId()) == `mp_m_freemode_01` then
			TriggerEvent('changetheplayer:loadSkin', {
				sex      = 0,
				tshirt_1 = 15,
				tshirt_2 = 0,
				arms     = 15,
...
function RemoveTattoo(name, label)
	...
	ESX.ShowNotification("You have removed the " .. GetLabelText(label) .. " tattoo")
end
