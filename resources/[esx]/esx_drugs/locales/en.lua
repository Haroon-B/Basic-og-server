Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'press ~INPUT_CONTEXT~ to harvest the Cannabis plant.',
  ['weed_inventoryfull'] = 'you do not have any more inventory space for Cannabis.',
  ['weed_processprompt'] = 'press ~INPUT_CONTEXT~ to start Process Cannabis.',
  ['weed_processingstarted'] = 'processing Cannabis into Marijuana...',
  ['weed_processingfull'] = 'processing canceled due to full inventory!',
  ...
  ['weed_processingtoofar'] = 'the processing has been canceled due to you abandoning the area.',

  -- drug dealer
  ['dealer_prompt'] = 'press ~INPUT_CONTEXT~ to talk with the Drug Dealer.',
  ...
  ['license_no'] = 'no',
  ['license_bought'] = 'you bought the %s for $%s',
