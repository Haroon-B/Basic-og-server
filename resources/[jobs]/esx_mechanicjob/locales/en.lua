Locales['en'] = {
  ['mechanic']                  = 'mechanic',
  ['drive_to_indicated']        = 'Drive~s~ to the indicated location.',
  ['mission_canceled']          = 'Mission canceled~s~',
  ...
  ['not_experienced_enough']    = 'you are not experienced enough~s~ to perform this action.',
  ['gas_can']                   = 'gas Can',
  ...
  ['must_near']                 = 'you must be near a vehicle~s~ to impound it.',
  ['vehicle_success_attached']  = 'vehicle successfully attached~s~',
  ['please_drop_off']           = 'please drop off the vehicle at the garage',
  ['cant_attach_own_tt']        = 'you can\'t~s~ attach own tow truck',
  ['no_veh_att']                = 'there is no vehicle~s~ to be attached',
  ['not_right_veh']             = 'this is not the right vehicle',
  ['veh_det_succ']              = 'vehicle successfully dettached~s~!',
  ['imp_flatbed']               = 'Action impossible!~s~ You need a Flatbed~s~ to load a vehicle',
  ['objects']                   = 'objects',
  ['roadcone']                  = 'roadcone',
  ['toolbox']                   = 'toolbox',
  ...
  ['please_tow']                = 'please tow~s~ the vehicle',
  ['wait_five']                 = 'you must wait~s~ 5 mintes',
  ...
  ['recovery_repair_tools']     = 'Repair Tools~s~ Retrieval...',
  ['recovery_body_tools']       = 'Body Tools~s~ Retrieval...',
  ['not_enough_gas_can']        = 'You do not have enough~s~ gas cans.',
  ['assembling_blowtorch']      = 'Assembling Blowtorch~s~...',
  ['not_enough_repair_tools']   = 'You do not have enough~s~ repair tools.',
  ['assembling_repair_kit']     = 'Assembling Repair Kit~s~...',
  ['not_enough_body_tools']     = 'You do not have enough~s~ body tools.',
  ['assembling_body_kit']       = 'Assembling Body Kit~s~...',
  ['your_comp_earned']          = 'your company has earned~s~ $',
