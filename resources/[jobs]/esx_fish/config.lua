Config = {}
	...
	Config.SellFish = {x = -1845.22, y = -1195.97, z = 18.18} --Place where players can sell their fish
	Config.SellTurtle = {x = 3804.0, y = 4443.3, z = 3.2} --Place where players can sell their turtles 
	Config.SellShark = {x = 3817.77 , y = 4481.9, z = 4.99} --Place where players can sell their sharks
...
Config.MarkerZones = { 
	...
	{x = 3855.0        ,y =  4463.7 ,z = 1.9, xs = 3885.2       , ys =  4507.2, zs = 1.0 },
