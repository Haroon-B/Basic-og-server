Locales['en'] = {
  ...
  ['open_cloackroom'] = 'press ~INPUT_CONTEXT~ to change clothes~s~.',
  -- Armory
  ...
  ['armory'] = 'armory',
  ['open_armory'] = 'press ~INPUT_CONTEXT~ to access the Armory~s~.',
  ['armory_owned'] = 'owned',
  ['armory_free'] = 'free',
  ['armory_item'] = '$%s',
  ['armory_weapontitle'] = 'armory - Buy weapon',
  ['armory_componenttitle'] = 'armory - Weapon attatchments',
  ['armory_bought'] = 'you bought an %s~s~ for $%s~s~',
  ...
  ['garage_prompt'] = 'press ~INPUT_CONTEXT~ to access the Vehicle Actions~s~.',
  ...
  ['helicopter_prompt'] = 'press ~INPUT_CONTEXT~ to access the Helicopter Actions~s~.',
  ['helicopter_notauthorized'] = 'you\'re not authorized to buy helicopters.',
  ['shop_item'] = '$%s',
  ['vehicleshop_title'] = 'vehicle Shop',
  ['vehicleshop_confirm'] = 'do you want to buy this vehicle?',
  ['vehicleshop_bought'] = 'you have bought %s~s~ for $%s~s~',
  ['vehicleshop_money'] = 'you cannot afford that vehicle',
  ['vehicleshop_awaiting_model'] = 'the vehicle is currently DOWNLOADING & LOADING~s~ please wait',
  ['confirm_no'] = 'no',
  ['confirm_yes'] = 'yes',
  -- Service
  ...
  ['service_in_announce'] = 'operator %s~s~ has entered service!',
  ['service_out'] = 'you have left service.',
  ['service_out_announce'] = 'operator %s~s~ has left their service.',
  -- Action Menu
  ...
  ['license_revoked'] = 'your %s~s~ has been revoked~s~!',
  ['licence_you_revoked'] = 'you revoked a %s~s~ which belonged to %s~s~',
  ['no_players_nearby'] = 'there is no player(s) nearby!',
  ['being_searched'] = 'you are being searched~s~ by the Police~s~',
  -- Vehicle interaction
  ['vehicle_info'] = 'vehicle Info',
  ['pick_lock'] = 'lockpick Vehicle',
  ['vehicle_unlocked'] = 'vehicle Unlocked~s~',
  ['no_vehicles_nearby'] = 'there is no vehicles nearby',
  ['impound'] = 'impound vehicle',
  ['impound_prompt'] = 'press ~INPUT_CONTEXT~ to cancel the impound~s~',
  ...
  ['search_database_error_invalid'] = 'that is not~s~ a valid~s~ registration number',
  ['search_database_error_not_found'] = 'that registration number~s~ is not~s~ registered to an vehicle!',
  ['search_database_found'] = 'the vehicle is registered~s~ to %s~s~',
  -- Traffic interaction
  ...
  ['you_confiscated'] = 'you confiscated %sx~s~ %s~s~ from %s~s~',
  ['got_confiscated'] = '%sx~s~ %s~s~ were confiscated by %s~s~',
  ['you_confiscated_account'] = 'you confiscated $%s~s~ (%s) from %s~s~',
  ['got_confiscated_account'] = '$%s~s~ (%s) was confiscated by %s~s~',
  ['you_confiscated_weapon'] = 'you confiscated %s~s~ from %s~s~ with %s~s~ bullets',
  ['got_confiscated_weapon'] = 'your %s~s~ with %s~s~ bullets was confiscated by %s~s~',
  ...
  ['have_withdrawn'] = 'you have withdrawn %sx~s~ %s~s~',
  ['have_deposited'] = 'you have deposited %sx~s~ %s~s~',
  ['quantity'] = 'quantity',
  ['inventory'] = 'inventory',
