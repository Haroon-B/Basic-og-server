Locales['en'] = {
  ...
  ['bank_deposit_returned']     = 'a security deposit of $%s~s~ was returned to you.',
  ['bank_deposit_taken']        = 'a security deposit of $%s~s~ was taken from you.',
  ...
  ['max_limit']                 = 'you cannot carry more %s~s~',
  ['not_enough']                = 'you do not have enough %s~s~ to continue this task.',
