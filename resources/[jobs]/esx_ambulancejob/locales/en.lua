Locales['en'] = {
  ...
  ['revive_complete'] = 'you have revived %s~s~',
  ['revive_complete_award'] = 'you have revived %s~s~ and earned $%s~s~!',
  ['revive_fail_offline'] = 'that player is no longer online',
  ['heal_inprogress'] = 'you are healing!',
  ['heal_complete'] = 'you have healed %s~s~',
  ...
  ['actions_prompt'] = 'press ~INPUT_CONTEXT~ access the Ambulance Actions~s~.',
  ...
  -- Death
  ['respawn_available_in'] = 'respawn available in %s minutes %s seconds~s~',
  ['respawn_bleedout_in'] = 'you will bleed out in %s minutes %s seconds~s~\n',
  ['respawn_bleedout_prompt'] = 'hold [~b~E~s~] ~w~to respawn',
  ['respawn_bleedout_fine'] = 'hold [~b~E~s~] ~w~to respawn for $%s~s~',
  ['respawn_bleedout_fine_msg'] = 'you paid $%s~s~ to respawn.',
  ['distress_send'] = 'press [~b~G~s~] ~w~to send distress signal',
  ...
  -- Item
  ['used_medikit'] = 'You have used 1x~s~ medikit',
  ['used_bandage'] = 'You have used 1x~s~ bandage',
  ['not_enough_medikit'] = 'You do not have medikit~s~.',
  ['not_enough_bandage'] = 'You do not have bandage~s~.',
